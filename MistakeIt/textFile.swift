...
let leveltexts = ["lamp": "O erro é um aprendizado e não apenas um erro!",
                  "papersticker": "Ser descolado pode ser bom também!",
                  "penicillin": "O erro pode mover as coisas para o lugar certo!",
                  "docedeleite": "Errar pode ser delicioso!",
                  "pacemaker": "As vezes precisamos errar passo a passo!"]
