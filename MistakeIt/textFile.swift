...
let levelcomplete : [LevelState:String] = [.lamp:"Thomas Edison em 1879 mencionou que foram necessários mais de 100 testes diferentes antes de se chegar ao modelo final. 'Eu aprendi muito mais com os meus erros do que com meus acertos.'",
                                           ...
                                           .pace: "O marca passo foi inventado por Wilson Greatbatch em 1956. Inicialmente o pesquisador estava construindo um dispositivo para medir os movimentos cardíacos. Ao trabalhar em seu dispositivo, porém, removeu acidentalmente um dos fios do aparelho, o que fez com que o aparelho emitisse sinais elétricos em um ritmo semelhante às batidas do coração humano. Isso permitiu criar um aparelho para induzir o coração aos batimentos corretos a partir dos sinais elétricos."]
